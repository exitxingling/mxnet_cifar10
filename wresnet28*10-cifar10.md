...
def train(net, train_data, valid_data, num_epochs, lr, wd, ctx, lr_period, lr_decay):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch > 0 and epoch == lr_period:
            ...
            net.save_params('wresnet28*10_%depoch.params' % epoch)
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Epoch 0. Loss: 4.680896, Train acc 0.050000, Time 00:00:35, lr 0.1\n"
 }
]
```
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Epoch 0. Loss: 3.504004, Train acc 0.100000, Time 00:00:02, lr 0.1\n"
 }
]
```
